import { unwrapModelContentEnvelope } from "../converters/modelContentEnvelope.js";
import { toAISDKContent, toAISDKDefaultOutput } from "../converters/toolOutputConversion.js";
import { frontendTools } from "./frontendTools.js";
import { jsonSchema } from "ai";
import { toJSONSchema } from "assistant-stream";
import { createMCPClient } from "@ai-sdk/mcp";
import { Experimental_StdioMCPTransport } from "#mcp-stdio";
//#region src/tools/generativeTools.ts
const EMPTY_SCHEMA = {
	type: "object",
	properties: {}
};
...
var AISDKToolkit = class {
	...
	#mcpClient(name, config, startedAt) {
		...
		next = withMcpConnectionTimeout(createPromise, {
			...
			if (error instanceof MCPConnectionTimeoutError) createPromise.then((client) => client.close()).catch(() => {});
			throw error;
		});
