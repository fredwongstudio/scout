...
function useThreadTokenUsage() {
	const $ = c(2);
	const msg = useAuiState(_temp);
	let t0;
	if ($[0] !== msg) {
		t0 = getThreadMessageTokenUsage(msg);
		$[0] = msg;
		$[1] = t0;
	} else t0 = $[1];
	return t0;
...
function _temp(s) {
	return findLatestMessageWithUsage(s.thread.messages);
}
//#endregion
