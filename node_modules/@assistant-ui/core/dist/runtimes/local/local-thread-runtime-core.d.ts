...
import { LocalRuntimeOptionsBase } from "./local-runtime-options.js";
import "../../index.js";
//#region src/runtimes/local/local-thread-runtime-core.d.ts
declare class LocalThreadRuntimeCore extends BaseThreadRuntimeCore implements ThreadRuntimeCore {
  ...
  respondToToolApproval({ approvalId, approved, optionId, reason }: RespondToToolApprovalOptions): void;
}
//#endregion
