...
const MessagePartComponent = (t0) => {
	...
	switch (type) {
		...
		case "generative-ui": {
			...
			const t11 = part;
			let t12;
			if ($[37] !== generativeUI.Fallback || $[38] !== generativeUI.components || $[39] !== t11.spec) {
				t12 = /* @__PURE__ */ jsx(GenerativeUIRender, {
					spec: t11.spec,
					components: generativeUI.components,
					Fallback: generativeUI.Fallback
				});
				$[37] = generativeUI.Fallback;
				$[38] = generativeUI.components;
				$[39] = t11.spec;
				$[40] = t12;
			} else t12 = $[40];
			return t12;
...
const RegisteredToolUI = () => {
	...
	let t0;
	if ($[0] !== Render || $[1] !== aui.part.addToolResult || $[2] !== aui.part.respondToToolApproval || $[3] !== aui.part.resumeToolCall || $[4] !== part) {
		t0 = /* @__PURE__ */ jsx(Render, {
			...part,
		...
		$[0] = Render;
		$[1] = aui.part.addToolResult;
		$[2] = aui.part.respondToToolApproval;
		$[3] = aui.part.resumeToolCall;
		$[4] = part;
		$[5] = t0;
	} else t0 = $[5];
	return t0;
