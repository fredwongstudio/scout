...
var CloudFileAttachmentAdapter = class {
	...
	async *add({ file }) {
		...
		yield attachment;
		try {
			const { signedUrl, publicUrl } = await this.getCloud().files.generatePresignedUploadUrl({ filename: file.name });
