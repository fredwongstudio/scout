import { AppendMessage, MessageRole, RunConfig, ThreadMessage } from "../../types/message.js";
...
//#region src/runtime/api/thread-runtime.d.ts
...
type ThreadListItemRuntimeBinding = SubscribableWithState<ThreadListItemState, ThreadListItemRuntimePath>;
type ThreadState = {
  /**
   * The thread ID.
