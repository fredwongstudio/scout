import { AssistantClient, ClientMethods, ClientNames } from "./types/client.js";
...
declare const applyTransformScopes: (clients: useAui.Props, parent: AssistantClient) => Record<string, ScopeElement>;
declare const useAuiRoot: ({ parent, entries, clientRef, notifications, destroySignal }: {
  parent: AssistantClient;
  entries: ScopeEntry[];
  clientRef: ClientRef;
...
//#endregion
export { ClientRef, ScopeEntry, applyTransformScopes, useAui, useAuiRoot, useConfiguredAui };
