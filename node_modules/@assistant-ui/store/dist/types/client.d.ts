...
type ScopeStates = { [K in ClientNames]: ClientSchemas[K]["methods"] extends {
  getState: () => infer S;
} ? S : never; };
/**
...
type ClientScopes = { [K in ClientNames]: AssistantClientAccessor<K>; };
/**
...
type AssistantClient = ClientScopes & {
  readonly optional: { readonly [K in keyof ClientScopes]: ClientScopes[K] | undefined; };
  subscribe(listener: () => void): Unsubscribe;
  on<TEvent extends AssistantEventName>(selector: AssistantEventSelector<TEvent>, callback: AssistantEventCallback<TEvent>): Unsubscribe;
};
//#endregion
export { AssistantClient, AssistantClientAccessor, AssistantState, ClientElement, ClientEvents, ClientMeta, ClientMethods, ClientNames, ClientOutput, ClientSchema, InferClientState, ScopeRegistry, Unsubscribe, ValidateClient };
