...
import { ToolModelContentPart } from "./tool-types.js";
//#region src/core/tool/ToolResponse.d.ts
declare const TOOL_RESPONSE_SYMBOL: unique symbol;
/** Stand-in result for a tool that completed without returning a value. */
declare const NO_RESULT = "<no result>";
/**
...
//#endregion
export { NO_RESULT, ToolResponse, ToolResponseLike };
