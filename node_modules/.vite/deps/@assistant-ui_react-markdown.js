...
import { K as useCallbackRef, M as useMessagePartText, u as internal_exports } from "./dist-BS7am2Fo.js";
...
//#region node_modules/@assistant-ui/react-markdown/dist/memoization.js
...
//#endregion
//#region node_modules/@assistant-ui/react-markdown/dist/overrides/PreOverride.js
...
var PreOverrideImpl = ({ children, ...rest }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreContext.Provider, {
		value: rest,
		children
	});
};
var PreOverride = (0, import_react.memo)(PreOverrideImpl, memoCompareNodes);
//#endregion
//#region node_modules/@assistant-ui/react-markdown/dist/overrides/defaultComponents.js
...
var DefaultCodeBlockContent = ({ node, components: { Pre, Code }, code }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pre, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code, {
	node,
	children: code
}) });
var DefaultCodeHeader = () => null;
//#endregion
//#region node_modules/@assistant-ui/react-markdown/dist/overrides/CodeBlock.js
var DefaultCodeBlock = ({ node, components: { Pre, Code, SyntaxHighlighter, CodeHeader }, language, code }) => {
	const components = (0, import_react.useMemo)(() => ({
		Pre,
		Code
	}), [Pre, Code]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CodeHeader, {
		node,
		language,
		code
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SyntaxHighlighter, {
		node,
		components,
		language,
		code
...
*/
//#endregion
//#region node_modules/@assistant-ui/react-markdown/dist/overrides/withDefaults.js
...
var CodeBlockOverride = ({ node, components: { Pre, Code, SyntaxHighlighter: FallbackSyntaxHighlighter, CodeHeader: FallbackCodeHeader }, componentsByLanguage = {}, children, ...codeProps }) => {
	const getPreProps = withDefaultProps((0, import_react.useContext)(PreContext));
	const WrappedPre = useCallbackRef((props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pre, { ...getPreProps(props) }));
	const getCodeProps = withDefaultProps(codeProps);
	const WrappedCode = useCallbackRef((props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code, { ...getCodeProps(props) }));
	const language = /language-([^\s]+)/.exec(codeProps.className || "")?.[1] ?? "";
	if (typeof children !== "string") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultCodeBlockContent, {
		node,
		components: {
			Pre: WrappedPre,
			Code: WrappedCode
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultCodeBlock, {
		node,
		components: {
			Pre: WrappedPre,
			Code: WrappedCode,
...
var CodeOverrideImpl = ({ node, components, componentsByLanguage, ...props }) => {
	if (!useIsMarkdownCodeBlock()) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(components.Code, { ...props });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CodeBlockOverride, {
		node,
		components,
...
var MarkdownTextInner = ({ components: userComponents, componentsByLanguage, smooth = true, defer = false, preprocess, ...rest }) => {
	const messagePartText = useMessagePartText();
	const { text } = useSmooth((0, import_react.useMemo)(() => {
	...
	const useCodeOverrideComponents = (0, import_react.useMemo)(() => {
		return {
			Pre: pre,
			Code: code,
			SyntaxHighlighter,
	...
	const CodeComponent = useCallbackRef((props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CodeOverride, {
...
var MarkdownTextPrimitiveImpl = (0, import_react.forwardRef)(({ className, containerProps, containerComponent: Container = "div", ...rest }, forwardedRef) => {
...
//#endregion
//#region node_modules/@assistant-ui/react-markdown/dist/preprocess.js
/**
...
*/
var LATEX_INLINE_DELIMITER = /\\{1,2}\(([^\n]+?)\\{1,2}\)/g;
var LATEX_DISPLAY_DELIMITER = /\\{1,2}\[([\s\S]+?)\\{1,2}\]/g;
/**
...
var MATH_TAG = /\[\/math\]([\s\S]*?)\[\/math\]/g;
var INLINE_TAG = /\[\/inline\]([\s\S]*?)\[\/inline\]/g;
/**
...
var LATEX_SYNTAX = /\\[a-zA-Z]|[_^{}]/;
var BLANK_LINE = /\n[ \t]*\n/;
var ADJACENT_WORDS = /[A-Za-z]{3,}\s+[A-Za-z]{3,}/;
var TRAILING_OPERATOR = /[-+*/=<>,;:([\u2013\u2014\u2212]$/;
...
function opensCurrencyAmount(text, index) {
...
*/
function endOfVerbatimRun(text, index) {
	const char = text[index];
	...
	return close !== -1 && !opensCurrencyAmount(text, close) && isMathBody(text.slice(index + 1, close)) ? close + 1 : index;
}
/**
